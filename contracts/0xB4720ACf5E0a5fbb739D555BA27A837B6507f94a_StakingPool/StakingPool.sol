...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        (bool success, ) = recipient.call{value: amount}("./StakingPool.sol");
   ...
   */
    ...
    */
        ...
        poolExist(strs[0])
    {
        ...
        IERC1155(_tokenAddress).safeTransferFrom(address(this),_to,  _tokenId, 1, "./StakingPool.sol");
        emit ClaimRewardNFT(_to, address(this), _signer, _tokenId, 1, strs[0], strs[1]);
    }
   ...
   */
    ...
    */
        ...
        poolExist(strs[0])
    {
        ...
        // Transfer token back to account
        IERC1155(_tokenAddress).safeTransferFrom(address(this), _account, tokenId, amount, "./StakingPool.sol");
    ...
    */
    ...
    {
        string memory poolId = strs[0];
        IERC1155(_tokenAddress).safeTransferFrom(msg.sender, address(this), tokenId, amount, "./StakingPool.sol");
        rewardNFT1155pPerPool[poolId][_tokenAddress][tokenId] += amount;
