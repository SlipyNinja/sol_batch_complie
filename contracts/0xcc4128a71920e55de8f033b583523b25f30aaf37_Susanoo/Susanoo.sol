...
contract Susanoo is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        if(amountETHMarketing>0){
            (tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 30000}("./Susanoo.sol");
        }

        if(amountETHDev>0){
            (tmpSuccess,) = payable(devFeeReceiver).call{value: amountETHDev, gas: 30000}("./Susanoo.sol");
        }
